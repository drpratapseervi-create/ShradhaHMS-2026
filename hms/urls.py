...
urlpatterns = [
    ...
    path("ipd/transfer/<int:admission_id>/", views.ipd_transfer, name="ipd_transfer"),
    path("ipd/bed/<int:bed_id>/housekeeping/", views.bed_housekeeping, name="bed_housekeeping"),
    path("ipd/census/", views.ipd_census, name="ipd_census"),
    path("ipd/review/", views.ipd_review, name="ipd_review"),
    ...
    path("ipd/edit/<int:admission_id>/", views.edit_admission, name="edit_admission"),
    ...
    path("ipd/<int:admission_id>/bill/", views.admission_bill, name="admission_bill"),
    path("ipd/<int:admission_id>/advance-receipt/", views.admission_advance_receipt, name="admission_advance_receipt"),
    path("ipd/<int:admission_id>/final-receipt/", views.admission_final_receipt, name="admission_final_receipt"),
